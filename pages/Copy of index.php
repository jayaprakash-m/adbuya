...
-->
			<!--	<div class="bor_blue"></div>-->
            	...
            	<div class="just_expand  dnone" id="just_post_off_content">
                    ...
                    <div class="form">
                	<form action="sdfsd.php"  name="post_offer_ad" id="post_offer_ad" enctype="multipart/form-data" method="post">
                    	<div class="select_cat">
                                               <div class="scat">Select Category</div>
                        	<div class="want_category">
				...
				<div class="w_cat1">
                    ...
                    <div class="w_cat1">
                        ...
                        <div class="w_cat1">
                            ...
                            <div class="box_area">
                           	  <input type="radio" name="contact_by" value="radio" /> 
                           	  E-mail  &nbsp;&nbsp;&nbsp;
                           	   <input type="radio" name="contact_by" value="radio2" /> 
                           	   Used                            </div>
                        </div>
                    ...
                    <div class="w_cat1">
                        ...
                        <div class="w_cat1">
                       	  <div class="label1">
                       		<input type="submit" onclick="return post_offer_ad();"  value="POST MY AD" class="but" />
							<script>
							post_offer_ad();
							</script>
                          </div>
